...
platformer.Hero.prototype = _hx_a(
  ...
  'play_animation', function(self,_self,anim) 
    if (_self.anim ~= anim) then 
      _G.msg.post("#sprite",defold.SpriteMessages.play_animation,_hx_o({__fields__={id=true},id=anim}));
      _self.anim = anim;
    end;
  end,
  ...
  'on_message', function(self,_self,message_id,message,_) 
    if (message_id == defold.PhysicsMessages.contact_point_response) then 
  ...
  'on_input', function(self,_self,action_id,action) 
    local action_id1 = action_id;
    if (action_id1) == platformer.Hero.input_jump then 
    ...
    elseif (action_id1) == platformer.Hero.input_left then 
      _self.move_input = -action.value;
      _self.direction = -1;
    elseif (action_id1) == platformer.Hero.input_right then 
      _self.move_input = action.value;
      _self.direction = 1;
    elseif (action_id1) == platformer.Hero.input_touch then 
...
platformer.Main.prototype = _hx_a(
  'init', function(self,_) 
    _G.msg.post("@render:",defold.RenderMessages.clear_color,_hx_o({__fields__={color=true},color=_G.vmath.vector4(0.37647058823529411,0.58039215686274515,0.72549019607843135,0)}));
  end
)
